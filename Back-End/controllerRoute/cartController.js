...
cartController.get("/fetchcart/:userId", async (req, res) => {
  try {
...
cartController.put("/updatecart", async (req, res) => {
  try {
    const { userId, productId, quantity } = req.body;
...
cartController.delete("/deletecart/:userId/:productId", async (req, res) => {
  try {
